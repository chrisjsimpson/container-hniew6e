...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hniew6e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hniew6e.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-hniew6e.git
cd container-hniew6e
```
...
```
docker attach container-hniew6e
```
